...
Route::group(['domain' => domain()], function () {
    ...
    Route::name('backend.')
        ...
        Route::name('contacts.')->prefix('contacts')->group(function () {
            ...
            Route::get('{contact}')->name('edit')->uses('ContactsController@form')->where('contact', '[a-z0-9-]+');
            Route::put('{contact}')->name('update')->uses('ContactsController@update')->where('contact', '[a-z0-9-]+');
            Route::get('{contact}/logs')->name('logs')->uses('ContactsController@logs')->where('contact', '[a-z0-9-]+');
            Route::delete('{contact}')->name('delete')->uses('ContactsController@delete')->where('contact', '[a-z0-9-]+');
        });

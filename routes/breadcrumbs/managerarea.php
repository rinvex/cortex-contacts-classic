...
Breadcrumbs::for('managerarea.cortex.contacts.contacts.index', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('managerarea.cortex.contacts.contacts.import', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('managerarea.cortex.contacts.contacts.import.logs', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.contacts.contacts.index');
    $breadcrumbs->push(trans('cortex/contacts::common.import'), route('managerarea.cortex.contacts.contacts.import'));
    $breadcrumbs->push(trans('cortex/contacts::common.logs'), route('managerarea.cortex.contacts.contacts.import.logs'));
});

Breadcrumbs::for('managerarea.cortex.contacts.contacts.create', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.contacts.contacts.index');
    $breadcrumbs->push(trans('cortex/contacts::common.create_contact'), route('managerarea.cortex.contacts.contacts.create'));
});

Breadcrumbs::for('managerarea.cortex.contacts.contacts.edit', function (Generator $breadcrumbs, Contact $contact) {
    $breadcrumbs->parent('managerarea.cortex.contacts.contacts.index');
    $breadcrumbs->push(strip_tags($contact->full_name), route('managerarea.cortex.contacts.contacts.edit', ['contact' => $contact]));
});

Breadcrumbs::for('managerarea.cortex.contacts.contacts.logs', function (Generator $breadcrumbs, Contact $contact) {
    $breadcrumbs->parent('managerarea.cortex.contacts.contacts.index');
    $breadcrumbs->push(strip_tags($contact->full_name), route('managerarea.cortex.contacts.contacts.edit', ['contact' => $contact]));

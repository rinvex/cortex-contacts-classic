...
Breadcrumbs::register('managerarea.contacts.edit', function (BreadcrumbsGenerator $breadcrumbs, ContactContract $contact) {
    $breadcrumbs->parent('managerarea.contacts.index');
    $breadcrumbs->push($contact->name, route('managerarea.contacts.edit', ['contact' => $contact]));
});

Breadcrumbs::register('managerarea.contacts.logs', function (BreadcrumbsGenerator $breadcrumbs, ContactContract $contact) {
    $breadcrumbs->parent('managerarea.contacts.index');
    $breadcrumbs->push($contact->name, route('managerarea.contacts.edit', ['contact' => $contact]));

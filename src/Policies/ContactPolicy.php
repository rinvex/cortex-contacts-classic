...
class ContactPolicy
{
     ...
     * @return bool
     */
    public function update($ability, UserContract $user, ContactContract $resource): bool
    {
     ...
     * @return bool
     */
    public function delete($ability, UserContract $user, ContactContract $resource): bool
    {

    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                @if($contact->exists && $currentUser->can('delete', $contact)) <div class="pull-right"><a href="#" data-toggle="modal" data-target="#delete-confirmation" data-modal-action="{{ route('adminarea.contacts.destroy', ['contact' => $contact]) }}" data-modal-title="{!! trans('cortex/foundation::messages.delete_confirmation_title') !!}" data-modal-body="{!! trans('cortex/foundation::messages.delete_confirmation_body', ['resource' => trans('cortex/contacts::common.contact'), 'identifier' => $contact->full_name]) !!}" title="{{ trans('cortex/foundation::common.delete') }}" class="btn btn-default" style="margin: 4px"><i class="fa fa-trash text-danger"></i></a></div> @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                        ...
                                        {{ Form::tel('raw_phone', $contact->phone, ['class' => 'form-control', 'placeholder' => trans('cortex/contacts::common.phone')]) }}
